...
- The repository currently tracks an MIT license. Review dependency, dataset, model, and publication constraints before public distribution or package publication.

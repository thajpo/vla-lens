...
class MiniVLAPolicy(OpenVLAPolicy):
    ...
    def _try_load(self) -> None:
        ...
        if hasattr(self._model, "action_tokenizer") and hasattr(self._model.action_tokenizer, "vq_vae"):
            self._model.action_tokenizer.vq_vae.encoder = self._model.action_tokenizer.vq_vae.encoder.to(target_device)
            self._model.action_tokenizer.vq_vae.decoder = self._model.action_tokenizer.vq_vae.decoder.to(target_device)
            self._model.action_tokenizer.vq_vae.vq_layer = self._model.action_tokenizer.vq_vae.vq_layer.to(target_device)
            self._model.action_tokenizer.vq_vae.device = target_device
            self._model.action_tokenizer.device = target_device
